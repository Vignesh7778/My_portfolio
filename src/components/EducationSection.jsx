      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <Tilt options={{ max: 15, scale: 1.05 }}>
            <a href="https://www.guvi.in/share-certificate/9W63z22U323T6781rn" target="_blank" rel="noreferrer" className="hud-panel p-6 md:p-10 flex flex-col items-center text-center group h-full block">
              ...
              <p className="text-[9px] text-gray-600 uppercase font-mono tracking-tighter">GUVI CERTIFICATION</p>
            </a>
          </Tilt>

          <Tilt options={{ max: 15, scale: 1.05 }}>
            <a href="https://www.linkedin.com/posts/vignesh-m-b4a5ba300_successfully-completed-a-full-stack-web-development-activity-7351233165304176640-RgQm/?utm_source=share&utm_medium=member_desktop&rcm=ACoAAEz5wOoBVVDLAbdIPDaqOLdkDjJINfZ_WCQ" target="_blank" rel="noreferrer" className="hud-panel p-6 md:p-10 flex flex-col items-center text-center group h-full block">
              <div className="w-16 h-16 border border-white/10 flex items-center justify-center mb-8 grayscale group-hover:grayscale-0 transition-all group-hover:border-cyber-cyan group-hover:shadow-[0_0_15px_rgba(0,243,255,0.2)]">
              ...
              <p className="text-[9px] text-gray-600 uppercase font-mono tracking-tighter">INTERNSHIP COMPLETION</p>
            </a>
          </Tilt>

          <Tilt options={{ max: 15, scale: 1.05 }}>
            <a href="https://ibb.co/mrF5qBRk" target="_blank" rel="noreferrer" className="hud-panel p-6 md:p-10 flex flex-col items-center text-center group h-full block">
              <div className="w-16 h-16 border border-white/10 flex items-center justify-center mb-8 grayscale group-hover:grayscale-0 transition-all group-hover:border-cyber-cyan group-hover:shadow-[0_0_15px_rgba(0,243,255,0.2)]">
              ...
              <p className="text-[9px] text-gray-600 uppercase font-mono tracking-tighter">ACADEMIC EXCELLENCE</p>
            </a>
          </Tilt>

          <Tilt options={{ max: 15, scale: 1.05 }}>
            <a href="https://www.linkedin.com/posts/vignesh-m-b4a5ba300_cybersecurity-cyberhygiene-workshop-activity-7384221066644107265-qScE/?utm_source=share&utm_medium=member_android&rcm=ACoAAEz5wOoBVVDLAbdIPDaqOLdkDjJINfZ_WCQ" target="_blank" rel="noreferrer" className="hud-panel p-6 md:p-10 flex flex-col items-center text-center group h-full block">
              <div className="w-16 h-16 border border-white/10 flex items-center justify-center mb-8 grayscale group-hover:grayscale-0 transition-all group-hover:border-cyber-cyan group-hover:shadow-[0_0_15px_rgba(0,243,255,0.2)]">
              ...
              <p className="text-[9px] text-gray-600 uppercase font-mono tracking-tighter">WORKSHOP ATTENDANCE</p>
            </a>
          </Tilt>
